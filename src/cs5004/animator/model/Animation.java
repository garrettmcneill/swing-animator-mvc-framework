...
public interface Animation {
  ...
  /**
   * An animation updates its shape appropriately given the elapsed time. All constructors must
   * include animation start and end times. The updateShape will be used later in the project so
   * that a shape can get it's properties at time t.
   *
  ...
  /**
   * Method that patches the starting state of an animation given the previous animation end state.
   *
   * @param previousAnimation or null.
   */
